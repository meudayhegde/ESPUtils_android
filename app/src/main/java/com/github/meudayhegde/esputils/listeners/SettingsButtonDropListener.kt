        ...
        when (event?.action) {
            DragEvent.ACTION_DROP -> {
                ...
                val dialog = ButtonPropertiesDialog(
                    view.context,
                    remoteDialog,
                    ButtonPropertiesDialog.MODE_SINGLE,
            ...
            DragEvent.ACTION_DRAG_ENDED -> {
                ...
                DrawableCompat.setTint(
                    remoteDialog.dialogBinding.imageViewBtnSettings.drawable,
            ...
            DragEvent.ACTION_DRAG_ENTERED -> {
                ...
                DrawableCompat.setTint(
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        remoteDialog.context.getColor(
                            R.color.sky_blue
                        )
                    } else remoteDialog.context.resources.getColor(R.color.sky_blue)
                )
            }
